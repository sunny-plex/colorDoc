...
(function () {
    ...
    var queryColorDict = function (memory, colorStr) {
        ...
        if (rgbaMatch) {
            ...
            var newColorVariableName = '@CLR' + String(10000 + memory.colorDict.length);
    ...
    var myQueue = [
        ...
        function (memory) {
            printLog('2', 'STEP: ' + memory.step);
            printLog('1', 'Scanning less files ...');
        ...
        function (memory) {
            ...
            printLog('1', 'Scanning less files OK , ' + memory.fileMatchList.length + ' "' + memory.config.srcSuffix + '" file found!');
            memory.step = memory.step + 1;
        },
        function (memory) {
            printLog('2', 'STEP: ' + memory.step);
